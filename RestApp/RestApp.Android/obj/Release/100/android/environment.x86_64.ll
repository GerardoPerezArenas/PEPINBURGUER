; ModuleID = 'obj\Release\100\android\environment.x86_64.ll'
source_filename = "obj\Release\100\android\environment.x86_64.ll"
...
@__app_environment_variables_v_0.1 = internal constant [23 x i8] c"gen-compact-seq-points\00", align 16
...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"d6277750-a8f2-413a-93bb-14560dfc4dde\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"com.codigo369.restapp\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 50, ; number_of_assemblies_in_apk
	i32 0, ; bundled_assembly_name_width
	i32 2, ; number_of_assembly_store_files
	i32 20, ; number_of_dso_cache_entries
	i32 33555323, ; android_runtime_jnienv_class_token
	i32 100673845, ; jnienv_initialize_method_token
	i32 100673844, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.2 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 16
@__DSOCacheEntry_name.3 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
@__DSOCacheEntry_name.4 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 16
@__DSOCacheEntry_name.5 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 16
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [50 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
